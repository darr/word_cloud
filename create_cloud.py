...
# -*- coding: utf-8 -*-
#####################################
# File name : create_cloud.py
# Create date : 2019-08-19 11:57
# Modified date : 2019-08-19 13:27
# Author : DARREN
# Describe : not set
...
class CreateWordCloud:
    ...
    '''创建关键词云图'''
    def save_cloud_graph(self, word_dict, max_words, picturefile, save_name):
    ...
    def show_keywords(self, content, picturefile, words_num=20, save_name = 'test'):
        ...
        self.save_cloud_graph(keywords_text, words_num, picturefile, save_name)
        return

    '''展示高频词云图'''
    def show_topwords(self, content, picturefile, words_num=50, save_name = 'test'):
        topwords_text = self.extract_words(content)
        self.save_cloud_graph(topwords_text, words_num, picturefile, save_name)
        return
