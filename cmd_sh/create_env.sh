...
## Modified date : 2019-08-19 11:33
## Author : DARREN
## Describe : not set
...
pip install -i https://pypi.tuna.tsinghua.edu.cn/simple --upgrade matplotlib
pip install -i https://pypi.tuna.tsinghua.edu.cn/simple --upgrade wordcloud
#pip install -i https://pypi.tuna.tsinghua.edu.cn/simple --upgrade newspaper
pip install -i https://pypi.tuna.tsinghua.edu.cn/simple --upgrade newspaper3k  # newspaper python2 version
